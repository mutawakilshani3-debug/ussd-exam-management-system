-- ============================================================
-- USSD Exam Management System - Filess.io-safe schema
-- Filess.io grants your user privileges on ONE pre-created database
-- with its own name/user, so this version has NO "CREATE DATABASE"
-- or "USE" statement. Import this directly against the database
-- Filess.io already created for you (see connection details in
-- your Filess.io dashboard).
-- ============================================================
